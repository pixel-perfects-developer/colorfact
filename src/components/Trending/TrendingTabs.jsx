    ...
    if (isLoading) {
        return (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-[4%]">
                {[...Array(6)].map((_, i) => (
                    <div key={i} className="rounded-lg overflow-hidden border border-gray-200 bg-white shadow-sm animate-pulse">
                        <div className="w-full h-[16vw] 2xl:h-[16rem] bg-gray-200" />
