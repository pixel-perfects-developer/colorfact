...
//         className={`w-full ${tempFilters.price.length === 0 &&
//             tempFilters.avoid.length === 0 &&
//             tempFilters.brands.length === 0 &&
//             tempFilters.colors.length === 0
...
//         <div
//           className={`fixed inset-0 z-[4000] lg:hidden transition-opacity duration-300 ease-in-out ${showFilters ? "opacity-100 visible" : "opacity-0 invisible"
//             }`}
//         >
//           {/* Fond assombri */}
//           <div
//             className={`absolute inset-0 bg-black/30 transition-opacity duration-300 ease-in-out ${showFilters ? "opacity-100" : "opacity-0"
//               }`}
...
//           {/* Panneau latéral */}
//           <div
//             className={`absolute top-0 right-0 h-full w-[80%] sm:w-[70%] bg-white shadow-lg rounded-tl-2xl transform transition-transform duration-[600ms] ease-[cubic-bezier(0.25,0.8,0.25,1)] ${showFilters ? "translate-x-0" : "translate-x-full"
//               } overflow-y-auto p-6`}
...
const OutfitFilterPage = () => {
  ...
  const renderFilterSections = () => (
    <>
      {[ // same structure, but colors are dynamic from Redux now
